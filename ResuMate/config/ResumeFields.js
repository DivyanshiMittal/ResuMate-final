export default {
    contact: {
        ...
        name: 'Contact',
        fields: [
            { name: 'name', label: 'Full Name', placeholder: 'Ex: Divyanshi Mittal', required: true },
            { name: 'title', label: 'Your Job Title', placeholder: 'Ex: Technical Analyst' },
            { name: 'email', label: 'Email', type: 'email', placeholder: 'Ex: divyanshi.mittal@example.com' },
            { name: 'phone', label: 'Phone', type: 'tel', placeholder: 'Ex: 7505971807' },
            { name: 'address', label: 'Address', placeholder: 'Ex: Vit Vellore' },
            { name: 'linkedin', label: 'Linked', placeholder: 'Ex: https://www.linkedin.com/in/abcexample-296783217' },
            { name: 'github', label: 'Github', placeholder: 'Ex: https://github.com/example' },
            { name: 'portfolio', label: 'Portfolio', placeholder: 'Ex: example.com' },
            { name: 'leetCode', label: 'LeetCode', placeholder: 'Ex: https://leetcode.com/example/' },
        ],
    },
    summary: {
        name: 'Summary',
